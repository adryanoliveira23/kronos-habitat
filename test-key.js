...
console.log("Cleaned VERY START:", JSON.stringify(cleanedKey.substring(0, 30)));
console.log(
  "Cleaned VERY END:",
  JSON.stringify(cleanedKey.substring(cleanedKey.length - 30)),
);
...
try {
  ...
  console.log("SUCCESS: Key is valid PEM");
} catch (e) {
