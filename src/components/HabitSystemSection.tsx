        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <p className="text-base sm:text-lg text-white/60 mb-8 font-medium">
              Crie hábitos com precisão cirúrgica. Defina a frequência, horários
              e a dificuldade. Quanto maior o desafio, maior a recompensa em XP
              e status.
            </p>
              ...
              {[
                {
                  ...
                  desc: "Diário, semanal ou padrões customizados.",
                },
                {
                  icon: Clock,
                  title: "Agendamento Estratégico",
                  desc: "Sincronize hábitos com seus picos de energia.",
                },
                {
                  icon: BarChart3,
                  title: "Dificuldade Dinâmica",
                  desc: "Ajuste o nível de desafio conforme evolui.",
                },
              ].map((item, i) => (
