...
export default function LoginPage({ onBack, onCreateAccount, onLoginSuccess }: LoginPageProps) {
    ...
    const handleLogin = (e: React.FormEvent) => {
        ...
        // Mimic API delay
        setTimeout(() => {
            if (email === "teste@gmail.com" && password === "carros02") {
                onLoginSuccess();
            } else {
                    ...
                    <div className="relative z-10">
                        ...
                        <div className="mb-8">
                            <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-neon-green/10 border border-neon-green/20 rounded-full mb-4">
                                ...
                                <span className="text-neon-green text-[10px] font-black uppercase tracking-widest">Sistema Online</span>
                            </div>
                            ...
                            <p className="text-white/40 text-sm mt-2 font-medium">Entre para desblocar sua evolução.</p>
                        </div>
                        ...
                        <form className="space-y-4" onSubmit={handleLogin}>
                            ...
                            <div className="flex justify-end px-2">
                                <button type="button" className="text-[10px] text-white/30 hover:text-neon-yellow font-bold uppercase tracking-widest transition-colors">
                                    Esqueceu a senha?
                                </button>
                            </div>
                        ...
                        <p className="text-center text-white/40 text-sm">
                            Não tem conta?{" "}
                            <button onClick={onCreateAccount} className="text-neon-yellow font-black hover:underline transition-all">
                                Criar conta
                            </button>
                        </p>
                    </div>
