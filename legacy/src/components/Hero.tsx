...
export default function Hero({ onGoToRegister }: { onGoToRegister: () => void }) {
  return (
    <section className="relative min-h-[90vh] sm:min-h-screen xl:min-h-[110vh] hero-bg-gradient overflow-hidden pt-32 sm:pt-40 lg:pt-32 xl:pt-48 pb-12 sm:pb-20 xl:pb-32 px-4 sm:px-8">
      ...
      <div className="relative mx-auto max-w-[1200px] z-10">
        ...
        <div className="text-center mb-12 sm:mb-16">
          ...
          >
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-white to-white/70">HACKEIE </span>
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-neon-green to-neon-yellow">SUA MENTE.</span>
          </motion.h1>
          ...
          >
            A procrastinação vence quando a força de vontade acaba. Transforme a disciplina no seu maior vício com o método de gamificação que recompensa cada tarefa concluída.
          </motion.p>
        ...
        <div className="relative grid grid-cols-1 lg:grid-cols-3 items-center gap-8 lg:gap-6 xl:gap-12 mt-6 lg:mt-10">
          ...
          >
            <div className="glass-card p-4 rounded-[32px] text-left">
              <div className="aspect-square rounded-[24px] bg-zinc-900/50 mb-4 overflow-hidden border border-white/5">
                <img src={petImg} alt="Pet" className="w-full h-full object-cover" referrerPolicy="no-referrer" />
              </div>
              <div className="flex justify-between items-center px-1">
                <div className="bg-black/40 backdrop-blur-md px-3 py-1.5 rounded-xl border border-white/10">
                  <div className="text-[7px] text-white/40 uppercase font-black tracking-wider">Rarity Score</div>
            ...
            <div className="text-left pl-2">
              <div className="flex items-center gap-2 mb-3">
                ...
                <span className="font-black font-sans text-sm uppercase tracking-tight text-white">CONQUISTE SEU PET</span>
              </div>
          ...
          >
            <div className="group cursor-default">
              <div className="text-3xl sm:text-4xl lg:text-3xl xl:text-5xl font-black font-sans mb-1 xl:mb-2 text-white group-hover:text-neon-green transition-colors">12.000+</div>
              <div className="text-[10px] text-white/40 font-bold uppercase tracking-[0.2em] leading-relaxed">Moedas Kronos</div>
            </div>
            <div className="group cursor-default">
              <div className="text-3xl sm:text-4xl lg:text-3xl xl:text-5xl font-black font-sans mb-1 xl:mb-2 uppercase text-white group-hover:text-neon-green transition-colors">NÍVEL 200</div>
              <div className="text-[10px] text-white/40 font-bold uppercase tracking-[0.2em] leading-relaxed">O seu nível aumenta conforme sua consistência.</div>
            </div>
            <div className="group cursor-default">
              <div className="text-3xl sm:text-4xl lg:text-3xl xl:text-5xl font-black font-sans mb-1 xl:mb-2 text-white group-hover:text-neon-green transition-colors">Top 6.5%</div>
              <div className="text-[10px] text-white/40 font-bold uppercase tracking-[0.2em] leading-relaxed">No ranking globo</div>
            </div>
          </motion.div>
        </div>
      </div>
