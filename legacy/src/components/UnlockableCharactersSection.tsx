...
const characters = [
    {
        ...
        rank: "NÍVEL 1-10",
        image: "https://i.ibb.co/Mm8fkMz/Chat-GPT-Image-1-de-mar-de-2026-21-15-22.png",
        score: "4.2/10",
    ...
    },
    {
        ...
        rank: "NÍVEL 50+",
        image: "https://i.ibb.co/8g808TTc/Chat-GPT-Image-1-de-mar-de-2026-21-15-10.png",
        score: "9.9/10",
                    ...
                    {characters.map((char, i) => (
                        ...
                        >
                            ...
                            <div className="relative rounded-[32px] overflow-hidden bg-white/[0.03] border border-white/10 p-4 transition-all duration-500 group-hover:border-white/20 group-hover:bg-white/[0.05]">
                                <div className="relative aspect-square rounded-[24px] overflow-hidden bg-black/40 mb-6">
                                    ...
                                    <div className="absolute top-4 right-4 bg-black/60 backdrop-blur-md px-3 py-1 rounded-full border border-white/10">
                                        <span className="text-white/60 text-[9px] font-bold uppercase">{char.rank}</span>
                                    </div>
                                </div>
                                ...
                                <div className="px-2 pb-2">
                                    <div className="flex items-center justify-between mb-4">
                                        <div>
                                            ...
                                            <p className="text-white/30 text-[10px] font-bold uppercase tracking-widest mt-1">{char.subtitle}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-center gap-4 bg-white/[0.03] rounded-2xl p-4 border border-white/5 relative overflow-hidden group/btn cursor-pointer overflow-hidden">
                                        <div className="flex-1">
                                            <div className="text-white/30 text-[9px] font-black uppercase tracking-tighter mb-1">Rarity Score:</div>
                                            <div className="text-white font-black text-lg">{char.score}</div>
                                        </div>
                            ...
                            <div className={cn(
                                ...
                                char.color.includes('green') ? 'bg-neon-green' : 'bg-neon-yellow'
                            )} />
                        </motion.div>
                    ))}
                </div>
                ...
                >
                    <div className="flex items-center gap-6 px-8 py-4 bg-white/[0.02] border border-white/5 rounded-full backdrop-blur-sm">
                        ...
                        <p className="text-white/40 text-[11px] font-bold uppercase tracking-wider">
                            <span className="text-white">+2.450 alunos</span> já desbloquearam personagens lendários
                        </p>
                    </div>
                </motion.div>
            </div>
